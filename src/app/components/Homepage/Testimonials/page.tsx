    ...
    <div className="py-16 bg-gray-50 px-4">
      <div className="text-center mb-12">
        ...
        <p className="mt-2 text-gray-600 max-w-5xl mx-auto">
          ...
          expectation. Our strategy has helped us achieve customer satisfaction
          and a great client retention rate.
        </p>
      </div>
      <div className="relative max-w-5xl mx-auto overflow-hidden grid md:grid-cols-2 gap-0 bg-white rounded-4xl border-2 border-orange-500">
