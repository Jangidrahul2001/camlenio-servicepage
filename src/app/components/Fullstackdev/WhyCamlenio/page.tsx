...
const WhyCamlenio = () => {
  return (
    <div className="relative max-w-[86rem] min-h-screen mx-auto px-4 py-16">
      <motion.div
      ...
      >
        <h2 className="text-3xl md:text-4xl lg:text-7xl font-bold text-gray-900 mb-4">
          Why <span className="text-orange-500 font-extrabold">Camlenio</span>{" "}
          Stands Out as a Full-Stack Development Company
        </h2>
        <p className="text-sm md:text-base lg:text-lg text-gray-700 max-w-5xl mx-auto">
